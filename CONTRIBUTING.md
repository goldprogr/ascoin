Contributing to asocoin Core
============================

The asocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the asocoin Core project, and is not to be
confused with overall asocoin Network Protocol consensus changes.

Whether a pull request is merged into asocoin Core rests with the project merge
...
Patches that change asocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the asocoin consensus, it must have been
...
The project leader is the release manager for each asocoin Core release.
