/* src/config/asocoin-config.h.  Generated from asocoin-config.h.in by configure.  */
/* src/config/asocoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef asocoin_CONFIG_H

#define asocoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.asocoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "asocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "asocoin Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "asocoin"
