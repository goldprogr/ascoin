...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case asocoin:
            return QString("asocoin");
        case mCDM:
            return QString("Milli-asocoin (1 / 1" THIN_SP_UTF8 "000)");
        case uCDM:
            return QString("Micro-asocoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
