                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("asocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a asocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and asocoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About asocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about asocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for asocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your asocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified asocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a asocoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the asocoin Core help message to get a list with possible asocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("asocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to asocoin network", "", count));
}
...
{
    QString strTitle = tr("asocoin Core"); // default title
...
/** Creates context menu, its actions, and asocoins up all the relevant signals for mouse events. */
