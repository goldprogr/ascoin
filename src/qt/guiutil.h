...
/** Utility functions used by the asocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render asocoin addresses in monospace font
...
// Parse "asocoin:" URI into recipient object, return true on successful parsing
