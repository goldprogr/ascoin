                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received asocoin from zCDM"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCDM"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCDM));
