...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "asocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* asocoin features */
        {"asocoin", "masternode", &masternode, true, true, false},
        {"asocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"asocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"asocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"asocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"asocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"asocoin", "startmasternode", &startmasternode, true, true, false},
        {"asocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"asocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"asocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"asocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"asocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"asocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"asocoin", "mnbudget", &mnbudget, true, true, false},
        {"asocoin", "preparebudget", &preparebudget, true, true, false},
        {"asocoin", "submitbudget", &submitbudget, true, true, false},
        {"asocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"asocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"asocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"asocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"asocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"asocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"asocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"asocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"asocoin", "mnsync", &mnsync, true, true, false},
        {"asocoin", "spork", &spork, true, true, false},
        {"asocoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"asocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use asocoind, or the -server option to asocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> asocoin-cli " + methodname + " " + args + "\n";
}
