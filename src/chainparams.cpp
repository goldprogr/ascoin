...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1541975454, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0464bc7e7eacdc87f305c988437431 61ae492452fe2e1de2ae8f4469f63f15f2074733be605ff3e41e00d459fecd50914ba13c3a6a0ce8002c5cb773c8f0d94dba");//66
        nDefaultPort = 18447;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 asocoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // asocoin: 0.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // asocoin: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // asocoin: 60 Seconds
        nMaturity = 49;
         ...
         *
            ...
            genesis.nVersion = 1
            genesis.GetHash = 0000088e8b37c03dcb6fb3e479a97068e1b124fdd361ec00ce8d87e600e8b8ad
            genesis.hashMerkleRoot = a698fa86207f427103d6d8a258fe5049b244eaf6b498ed16d00038dc33e2da00

         */
        const char* pszTimestamp = "asocoin it is new coin";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0454972c979fb299951148f1ff147230511a10b0b67cefa936f1642c61ef14e1f68a1c41126d906cfd290e4150ecb0ecb69cb007583bcc11484341108968990f18") << OP_CHECKSIG;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xa698fa86207f427103d6d8a258fe5049b244eaf6b498ed16d00038dc33e2da00"));
          ...
          vSeeds.push_back(CDNSSeedData("seed2.asocoin.org", "seed2.ascoin.org"));             // seed2
        ...
        //strSporkKey = "049752161dc97194c01b2b1779404c b541c81302648804a05ae64d22d70b3f2c72cbe4511d3f07a994d7c1b73fde4fae28b0102a53a1b561b08fcc10f53768c8d4";
		    strSporkKey = "049752161dc97194c01b2b1779404c b541c81302648804a05ae64d22d70b3f2c72cbe4511d3f07a994d7c1b73fde4fae28b0102a53a1b561b08fcc10f53768c8d4";
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("0464bc7e7eacdc87f305c98843743161ae492452fe2e1de2ae8f4469f63f15f2074733be605ff3e41e00d459fecd50914ba13c3a6a0ce8002c5cb773c8f0d94dba");
        nDefaultPort = 9530;
        nEnforceBlockUpgradeMajority = 51;
        nRejectBlockOutdatedMajority = 75;
        nToCheckBlockUpgradeMajority = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // asocoin: 1 day
        nTargetSpacing = 1 * 60;  // asocoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet asocoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet asocoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet asocoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet asocoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet asocoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // asocoin: 1 day
        nTargetSpacing = 1 * 60;        // asocoin: 1 minutes
