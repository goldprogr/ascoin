...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("asocoin Core asocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  asocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded asocoin transaction") + "\n" +
                               "  asocoin-tx [options] -create [commands]   " + _("Create hex-encoded asocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded asocoin transaction
