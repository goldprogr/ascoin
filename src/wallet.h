...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 asocoin at the same time
...
enum ZerocoinSpendStatus {
    Zasocoin_SPEND_OKAY = 0,                            // No error
    Zasocoin_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    Zasocoin_WALLET_LOCKED = 2,                         // Wallet was locked
    Zasocoin_COMMIT_FAILED = 3,                         // Commit failed, reset status
    Zasocoin_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    Zasocoin_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    Zasocoin_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    Zasocoin_TRX_CREATE = 7,                            // Everything related to create the transaction
    Zasocoin_TRX_CHANGE = 8,                            // Everything related to transaction change
    Zasocoin_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    Zasocoin_INVALID_COIN = 10,                         // Selected mint coin is not valid
    Zasocoin_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    Zasocoin_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    Zasocoin_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    Zasocoin_SPENT_USED_Zasocoin = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZasocoinAutoBackups(bool fEnabled)
    {
