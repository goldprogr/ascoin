...
In order to support loading of multiple wallets in asocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is asocoin.cpp.
...
Changes to asocoin.cpp
----------------------
asocoin.cpp is the entry point into asocoin-qt, and as such, will require some minor modifications to provide hooks for
